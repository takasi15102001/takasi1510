...
$(document).ready( function () {
    ...
    setInterval( function () {
        $.getJSON("data.html", function(result) {
            ...
            if(Q0_0 == 1 ){
                document.getElementById("state1").src = 'https://th.bing.com/th?q=AC+Motor+Icons&w=120&h=120&c=1&rs=1&qlt=90&cb=1&dpr=1.3&pid=InlineBlock&mkt=en-WW&cc=VN&setlang=vi&adlt=moderate&t=1&mw=247';
            }
            else {
